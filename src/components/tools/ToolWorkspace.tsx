...
const WIDGETS: Record<ToolWidget, ComponentType<{ tool: Tool }>> = {
  ...
  repair: dynamic(() => import("@/components/widgets/RepairWidget").then((m) => m.RepairWidget), { ssr: false, loading }),
  stamps: dynamic(() => import("@/components/widgets/StampsWidget").then((m) => m.StampsWidget), { ssr: false, loading }),
  "bookmark-split": dynamic(() => import("@/components/widgets/BookmarkSplitWidget").then((m) => m.BookmarkSplitWidget), { ssr: false, loading }),
  poster: dynamic(() => import("@/components/widgets/PosterWidget").then((m) => m.PosterWidget), { ssr: false, loading }),
  "merge-contents": dynamic(() => import("@/components/widgets/MergeContentsWidget").then((m) => m.MergeContentsWidget), { ssr: false, loading }),
