      ...
      <div className="container grid items-center gap-12 py-16 lg:grid-cols-[1.05fr_1fr] lg:gap-16 lg:py-24">
        <div>
          ...
          <p className="mt-6 max-w-[54ch] text-lg leading-relaxed text-muted-foreground">
            Compress, convert, merge, split, edit, sign and organise your PDFs — quickly and
            effortlessly.
          </p>
          ...
          <div className="mt-9 flex flex-wrap items-center gap-3">
            ...
            <Button asChild variant="secondary" size="lg">
              <Link href="/compress-pdf">Compress a PDF</Link>
            </Button>
          </div>

          <p className="mt-8 flex items-center gap-2 text-sm text-muted-foreground">
            <ShieldCheck className="size-4 text-success" aria-hidden="true" />
            Merging, splitting and editing happen inside your browser tab.
          </p>
        </div>
          ...
          {chooserOpen && pendingFile ? (
            <div className="animate-fade-in rounded-2xl border border-border bg-card p-6 shadow-lifted sm:p-8">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                {formatBytes(pendingFile.size)} · what would you like to do with it?
              </p>
            ...
            <>
              <FileUploader
                ...
                note="Files are processed on your device and are not uploaded anywhere."
                onFiles={(files) => {
              ...
              <p className="mt-4 text-center text-sm text-muted-foreground">
                Files are securely processed and automatically removed.
              </p>
            </>
          )}
        </div>
