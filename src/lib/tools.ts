/**
 * Single source of truth for every tool in PDFFlow.
...
export const tools: Tool[] = [
  {
    ...
    popular: true,
    seo: {
      title: "Compress PDF Online — Reduce PDF Size | PDFFlow",
      description:
        "Compress PDF files online quickly and easily. Reduce file size while maintaining excellent document quality with PDFFlow.",
    },
  },
  {
    slug: "merge-pdf",
    ...
    popular: true,
    seo: {
      title: "Merge PDF Online — Combine PDF Files | PDFFlow",
      description:
  ...
  },
  {
    ...
    popular: true,
    seo: {
      title: "Split PDF Online — Separate PDF Pages | PDFFlow",
      description:
        "Split a PDF by selecting pages, entering page ranges, or separating every page into its own file. Runs in your browser with PDFFlow.",
    },
  },
  {
    slug: "pdf-to-word",
    ...
    seo: {
      title: "PDF to Word Converter — PDF to DOCX | PDFFlow",
      description:
        "Convert PDF files into editable Word documents while keeping layout, headings and tables intact with PDFFlow.",
    },
  },
  {
    slug: "pdf-to-excel",
    ...
    seo: {
      title: "PDF to Excel Converter — Extract Tables to XLSX | PDFFlow",
      description:
        "Convert PDF tables into Excel spreadsheets you can sort, filter and edit. Accurate table detection with PDFFlow.",
    },
  },
  {
    slug: "pdf-to-ppt",
    ...
    seo: {
      title: "PDF to PowerPoint Converter — PDF to PPTX | PDFFlow",
      description:
        "Convert PDF documents into editable PowerPoint presentations, one slide per page, with PDFFlow.",
    },
  },
  {
    slug: "word-to-pdf",
    ...
    seo: {
      title: "Word to PDF Converter — DOCX to PDF | PDFFlow",
      description:
  ...
  },
  {
    ...
    seo: {
      title: "Excel to PDF Converter — XLSX to PDF | PDFFlow",
      description:
        "Convert Excel spreadsheets into PDFs with tidy page breaks and readable column widths, using PDFFlow.",
    },
  },
  {
    slug: "ppt-to-pdf",
    ...
    seo: {
      title: "PowerPoint to PDF Converter — PPTX to PDF | PDFFlow",
      description:
  ...
  },
  {
    ...
    seo: {
      title: "JPG to PDF Converter — Images to PDF | PDFFlow",
      description:
        "Turn JPG photos and scans into one PDF. Reorder pages, choose page size and download instantly with PDFFlow.",
    },
  },
  {
    slug: "png-to-pdf",
    ...
    config: { accept: ["png"] },
    seo: {
      title: "PNG to PDF Converter — Images to PDF | PDFFlow",
      description:
        "Convert PNG images into a single PDF document. Transparency is flattened onto a white page by PDFFlow.",
    },
  },
  {
    slug: "pdf-to-jpg",
    ...
    popular: true,
    seo: {
      title: "PDF to JPG Converter — Export PDF Pages as Images | PDFFlow",
      description:
  ...
  },
  {
    ...
    config: { mode: "rotate" },
    seo: {
      title: "Rotate PDF Online — Fix Page Orientation | PDFFlow",
      description:
  ...
  },
  {
    ...
    config: { mode: "delete" },
    seo: {
      title: "Delete PDF Pages Online — Remove Pages | PDFFlow",
      description:
  ...
  },
  {
    ...
    config: { mode: "extract" },
    seo: {
      title: "Extract PDF Pages Online — Save Selected Pages | PDFFlow",
      description:
        "Extract specific pages from a PDF into a new document. Select visually or enter page ranges with PDFFlow.",
    },
  },
  {
    slug: "reorder-pages",
    ...
    config: { mode: "reorder" },
    seo: {
      title: "Reorder PDF Pages Online — Rearrange a PDF | PDFFlow",
      description:
  ...
  },
  {
    ...
    config: { mode: "edit" },
    seo: {
      title: "Edit PDF Online — Visual PDF Page Editor | PDFFlow",
      description:
  ...
  },
  {
    ...
    popular: true,
    seo: {
      title: "Edit & Annotate PDF Online — Add Text and Drawings | PDFFlow",
      description:
  ...
  },
  {
    ...
    popular: true,
    seo: {
      title: "Crop PDF Online — Trim Page Margins | PDFFlow",
      description:
  ...
  },
  {
    ...
    popular: true,
    seo: {
      title: "Add a Watermark to PDF — Free Watermark Tool | PDFFlow",
      description:
  ...
  },
  {
    ...
    popular: true,
    seo: {
      title: "Sign PDF Online — Add an Electronic Signature | PDFFlow",
      description:
  ...
  },
  {
    ...
    seo: {
      title: "Password Protect PDF — Encrypt a PDF | PDFFlow",
      description:
  ...
  },
  {
    ...
    seo: {
      title: "Unlock PDF — Remove a PDF Password | PDFFlow",
      description:
  ...
  },
  {
    ...
    popular: true,
    seo: {
      title: "Translate PDF Online — Into English, Russian and More | PDFFlow",
      description:
  ...
  },
  {
    ...
    seo: {
      title: "OCR PDF Online — Make Scans Searchable | PDFFlow",
      description:
...

  {
    ...
    seo: {
      title: "Flatten PDF Online — Lock Form Fields | PDFFlow",
      description:
