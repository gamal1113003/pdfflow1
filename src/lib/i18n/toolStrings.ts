...
const ru: Record<string, { name: string; description: string; lede: string }> = {
  ...
  "repair-pdf": {
    name: "Восстановить PDF",
    description: "Попытаться открыть файл, который не открывается.",
    lede: "Восстановите повреждённый PDF, чтобы его снова можно было прочитать.",
  },
  "header-footer": {
    name: "Колонтитулы",
    description: "Добавить текст сверху или снизу каждой страницы.",
    lede: "Поставьте название, дату или номер дела на каждую страницу.",
  },
  "split-by-bookmarks": {
    name: "Разделить по закладкам",
    description: "Разбить документ по отметкам глав.",
    lede: "Разделите длинный документ по его закладкам — по файлу на раздел.",
  },
  "poster": {
    name: "Плакат",
    description: "Напечатать одну страницу на нескольких листах.",
    lede: "Увеличьте страницу на несколько листов, чтобы получился плакат.",
  },
  "merge-with-contents": {
    name: "Объединить с содержанием",
    description: "Соединить файлы и добавить кликабельное содержание.",
    lede: "Соберите документы в подшивку с содержанием в начале.",
  },
  "pdf-to-pdfa": {
    name: "PDF в PDF/A",
    description: "Преобразовать в архивный формат.",
    lede: "Преобразуйте PDF в PDF/A — формат для долговременного хранения.",
  },
  "scan-to-pdf": {
    name: "Сканировать камерой",
    description: "Сфотографировать документ и получить ровный PDF.",
    lede: "Сфотографируйте страницу — она станет ровной и читаемой.",
  },
  "fill-form": {
    name: "Заполнить форму",
    description: "Ввести данные в PDF-форму и сохранить её.",
    lede: "Заполните поля PDF-формы и при желании зафиксируйте их.",
  },
  "page-numbers": {
    name: "Нумерация страниц",
    description: "Пронумеровать страницы документа.",
    lede: "Поставьте номера страниц там, где нужно, в любом стиле.",
  },
  "pdf-to-text": {
    name: "PDF в текст",
    description: "Извлечь обычный текст из документа.",
    lede: "Получите слова из PDF в виде текстового файла.",
  },
  "extract-images": {
    name: "Извлечь изображения",
    description: "Сохранить картинки, встроенные в PDF.",
    lede: "Достаньте изображения из документа в исходном разрешении.",
  },
  "pages-per-sheet": {
    name: "Несколько страниц на листе",
    description: "Разместить несколько страниц на одном листе для печати.",
    lede: "Печатайте две, четыре и больше страниц на одном листе.",
  },
  "pdf-metadata": {
    name: "Свойства PDF",
    description: "Посмотреть и изменить скрытые данные документа.",
    lede: "Прочитайте скрытые свойства PDF, измените или удалите их.",
  },
  "compress-image": {
    name: "Сжать изображения",
    description: "Уменьшить фотографии и скриншоты.",
    lede: "Уменьшайте изображения для почты, сообщений и сайта.",
  },
  "qr-code": {
    name: "QR-код",
  ...
  "create-invoice": {
    ...
    lede: "Заполните данные и получите готовый счёт для печати.",
  },
  "job-application": {
    name: "Заявление о приёме на работу",
    description: "Собрать письмо и документы в один PDF.",
    lede: "Напишите письмо, приложите резюме и сертификаты — получится один файл.",
  },
  "blacken-pdf": {
    name: "Затемнить PDF",
...
const ruSeo: Record<string, { title: string; description: string }> = {
  ...
  "repair-pdf": {
    title: "Восстановить повреждённый PDF онлайн — бесплатно | orzix",
    description:
      "PDF, который не открывается, часто удаётся собрать заново из того, что в нём сохранилось. Работает в браузере, файл не загружается.",
  },
  "header-footer": {
    title: "Добавить колонтитулы в PDF онлайн — бесплатно | orzix",
    description:
      "Добавьте текст сверху или снизу каждой страницы PDF в любой из шести позиций, с автоматическими номерами страниц и датой.",
  },
  "split-by-bookmarks": {
    title: "Разделить PDF по закладкам онлайн — файл на главу | orzix",
    description:
      "Разбейте длинный PDF на отдельные файлы по закладкам, каждый с названием своего раздела. Всё выполняется в браузере.",
  },
  "poster": {
    title: "Напечатать PDF плакатом на нескольких листах | orzix",
    description:
      "Разбейте страницу PDF на несколько листов с припуском на подрезку, чтобы склеить плакат. Работает в браузере.",
  },
  "merge-with-contents": {
    title: "Объединить PDF с содержанием — бесплатно онлайн | orzix",
    description:
      "Соедините несколько документов в один файл с кликабельным содержанием и закладками в боковой панели. Работает в браузере.",
  },
  "pdf-to-pdfa": {
    title: "Преобразовать PDF в PDF/A онлайн — архивный формат | orzix",
    description:
      "Преобразуйте PDF в PDF/A-2b — архивный стандарт, который встраивает всё необходимое для правильного отображения файла в будущем.",
  },
  "scan-to-pdf": {
    title: "Сканировать документ камерой в PDF — бесплатно | orzix",
    description:
      "Сфотографируйте документ и получите выровненный PDF. Исправляется угол съёмки и освещение. Ничего не загружается — всё на вашем устройстве.",
  },
  "fill-form": {
    title: "Заполнить PDF-форму онлайн — бесплатно и без регистрации | orzix",
    description:
      "Введите данные в собственные поля PDF-формы и сохраните файл — с возможностью правки или с фиксацией значений. Работает в браузере.",
  },
  "page-numbers": {
    title: "Нумерация страниц PDF онлайн — бесплатно | orzix",
    description:
      "Добавьте номера страниц в PDF в любом месте и стиле. Пропустите титульный лист или продолжите нумерацию. Работает в браузере.",
  },
  "pdf-to-text": {
    title: "PDF в текст онлайн — извлечь текст из PDF | orzix",
    description:
      "Извлеките текст из PDF и скачайте его в формате .txt или скопируйте в буфер обмена. Всё выполняется в браузере.",
  },
  "extract-images": {
    title: "Извлечь изображения из PDF онлайн — бесплатно | orzix",
    description:
      "Сохраните изображения, встроенные в PDF, в исходном разрешении, а не снимки страниц. Работает в браузере.",
  },
  "pages-per-sheet": {
    title: "Несколько страниц PDF на одном листе — онлайн | orzix",
    description:
      "Разместите две, четыре, шесть или девять страниц PDF на одном листе, чтобы сэкономить бумагу. Работает в браузере.",
  },
  "pdf-metadata": {
    title: "Изменить или удалить метаданные PDF онлайн | orzix",
    description:
      "Посмотрите автора, название и программу, записанные внутри PDF, измените их или удалите полностью. Работает в браузере.",
  },
  "compress-image": {
    title: "Сжать изображения онлайн — уменьшить JPG, PNG и WEBP | orzix",
    description:
      "Уменьшайте изображения для почты и веба. Изменение размера, качества и формата между JPG, PNG и WEBP. Работает в браузере.",
  },
  "qr-code": {
  ...
  "create-invoice": {
    ...
    description:
      "Составьте счёт онлайн и скачайте его в PDF. Логотип, позиции, скидки и НДС, в любой валюте. Работает в браузере.",
  },
  "job-application": {
    title: "Заявление о приёме на работу в PDF — письмо и резюме в одном файле | orzix",
    description:
      "Напишите сопроводительное письмо и приложите резюме и сертификаты одним PDF-файлом. Всё выполняется в браузере.",
  },
  "blacken-pdf": {
