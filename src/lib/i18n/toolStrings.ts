...
const ru: Record<string, { name: string; description: string; lede: string }> = {
  ...
  "blacken-pdf": {
    name: "Затемнить PDF",
    description: "Безвозвратно удалить личные данные из документа.",
    lede: "Закройте личные данные — и они действительно удаляются, а не просто закрашиваются.",
  },
  "compare-pdf": {
    name: "Сравнить PDF",
    description: "Найти различия между двумя версиями документа.",
    lede: "Поставьте две версии рядом и посмотрите, что именно изменилось.",
  },
  "watermark-pdf": {
    name: "Водяной знак",
...
const ruSeo: Record<string, { title: string; description: string }> = {
  ...
  "blacken-pdf": {
    title: "Затемнить PDF онлайн — удалить текст навсегда | orzix",
    description:
      "Закройте личные данные в PDF так, чтобы они были удалены, а не скрыты. Работает в браузере, файл никуда не загружается.",
  },
  "compare-pdf": {
    title: "Сравнить два PDF онлайн — найти различия | orzix",
    description:
      "Сравните два PDF-файла и увидьте, что изменилось. Визуальное сравнение отмечает все различия на странице, текстовое показывает добавленные и удалённые слова.",
  },
  "watermark-pdf": {
