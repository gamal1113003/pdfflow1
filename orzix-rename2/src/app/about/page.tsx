...
export const metadata: Metadata = pageMetadata({
  title: "About orzix — Simple Tools for Every PDF",
  description:
    "orzix is a browser-first PDF toolkit. Most tools run on your own device, so your documents never leave it.",
  path: "/about",
});
    ...
    <div className="container py-14 sm:py-16">
      <header className="max-w-2xl">
        ...
        <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
          ...
          giving it back. orzix starts from the opposite assumption.
        </p>
      </header>
